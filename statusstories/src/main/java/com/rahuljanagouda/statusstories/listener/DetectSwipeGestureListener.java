package com.rahuljanagouda.statusstories.listener;
...
public class DetectSwipeGestureListener extends GestureDetector.SimpleOnGestureListener {
    ...
    private StatusStoriesActivity activity = null;

    public StatusStoriesActivity getActivity() {
        return activity;
    }

    public void setActivity(StatusStoriesActivity activity) {
